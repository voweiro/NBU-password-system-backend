...
function generateWelcomeEmailTemplate(fullName, email, temporaryPassword) {
    return `
        ...
        <body>
            <div class="header">
                <h1>🔐 Welcome to the Nigerian British Univeristy Password Management System</h1>
            </div>
            <div class="content">
                ...
                <div class="credentials-box">
                    ...
                    <div class="credential-item">
                        ...
                        <br></br>
                        <strong>   use this link to login: https://nbu-password-system-frontend.vercel.app</strong>
                    </div>
                </div>
